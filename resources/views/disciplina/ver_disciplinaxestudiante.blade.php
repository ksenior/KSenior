...
@section('title','Consulta Disciplina Estudiante')
...
@section('contenido')
	...
	@if (!isset($busqueda))
        ...
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 50%">
            ...
            {{ Form::open(['action' => 'DisciplinaController@ver_disciplinaxestudiante_consulta']) }}
                <div class="row">
                     @if ($errors->any())
	...
	@else<div class="row">
		...
		<div class="fixed-action-btn">
    		<a href="{{ route('disciplina.ver_disciplinaxestudiante') }}" class="btn-floating btn-large blue darken-4">
