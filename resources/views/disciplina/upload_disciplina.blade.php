...
@section('title','Subir Disciplina')
...
@section('contenido')
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 50%">
        <h5 class="blue-text text-darken-4">SUBIR DISCIPLINA - EXCEL</h5><br>
        {{ Form::open(['action' => 'DisciplinaController@upload_disciplina_consulta', 'enctype' => 'multipart/form-data']) }}
            {{csrf_field()}}
            <div class="row">
                @if (isset($flash))
