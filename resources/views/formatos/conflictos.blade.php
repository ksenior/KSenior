...
<body>
	...
	<table class="bordered contenido mt-3">
		...
		<tr>
			<td class="bold">JORNADA</td><td>{{ $key->jornada }}</td><td class="bold">DOCENTE</td><td>{{ $key->docente }}</td><td class="bold">CORRECTIVO</td><td>{{ $key->tiporeg}}</td>
		</tr>
		<tr>
			<td class="bold" colspan="6">VERSION ESTUDIANTE</td>
		</tr>
		<tr>
			<td colspan="6" class="versiones">{{ $key->versionestudiante }}</td>
		</tr>
		<tr>
			<td class="bold" colspan="6">VERSION DOCENTE</td>
		</tr>
		<tr>
			<td colspan="6" class="versiones">{{ $key->versiondocente }}</td>
		</tr>
		<tr>
			<td class="bold" colspan="6">VERSION ACUDIENTE</td>
		</tr>
		<tr>
			<td colspan="6" class="versiones">{{ $key->versionfamilia }}</td>
		</tr>
		<tr>
			<td class="bold" colspan="6">OBSERVACIONES</td>
		</tr>
		<tr>
			<td colspan="6" class="versiones">{{ $key->observacion }}</td>
		</tr>
	</table>
