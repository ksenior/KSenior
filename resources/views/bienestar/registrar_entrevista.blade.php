...
@section('title','Registrar Entrevista')
...
@section('contenido')
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 40%">
        <h5 class="blue-text text-darken-4">Datos de Entrevista</h5><br>
        {{ Form::open(['action' => 'BienestarController@buscar_ausencia_consulta', 'method' => 'PUT']) }}
            ...
            <div class="row">
                ...
                <input type="hidden" name="opcion" value="7"> <!-- 5 PARA REGISTRO CITACION -->
            </div>
            <div class="row">
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 80%">
        <h5 class="blue-text text-darken-4">Datos de Entrevista</h5><br>
        {{ Form::open(['action' => 'BienestarController@registrar_entrevista_consulta', 'method' => 'POST']) }}
            {{csrf_field()}}
            <div class="row">
                @if (isset($flash))
                    <div class="card-panel notifications {{ $flash['color'] }}">
                ...
                <div class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="col l4">
                            ...
                            <input type="text" name="acudiente" required="required">
                        </div>
                        <div class="col l4">
                            <h6 class="blue-text text-darken-4">PSICOLOGA</h6>
                            <input type="text" name="docente" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col l4">
                            <h6 class="blue-text text-darken-4">Motivo Entrevista</h6>
                            <textarea name="motivo" class="materialize-textarea"></textarea>
                        </div>
                        <div class="input-field col l4">
                        ...
                        <div class="input-field col l4">
                            <h6 class="blue-text text-darken-4">CONCLUSIONES</h6>
                            <textarea name="conclusiones" class="materialize-textarea"></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="fixed-action-btn">
        <a href="{{ route('bienestar.registrar_entrevista') }}" class="btn-floating btn-large blue darken-4">
