...
@section('title','Registrar Citacion')
...
@section('contenido')
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 40%">
        <h5 class="blue-text text-darken-4">Datos de Citacion</h5><br>
        {{ Form::open(['action' => 'BienestarController@buscar_ausencia_consulta', 'method' => 'PUT']) }}
            ...
            <div class="row">
                ...
                <input type="hidden" name="opcion" value="5"> <!-- 5 PARA REGISTRO CITACION -->
            </div>
            <div class="row">
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 80%">
        <h5 class="blue-text text-darken-4">Datos de Citacion</h5><br>
        {{ Form::open(['action' => 'BienestarController@registrar_citacion_consulta', 'method' => 'POST']) }}
            {{csrf_field()}}
            <div class="row">
                @if (isset($flash))
                    <div class="card-panel notifications {{ $flash['color'] }}">
                ...
                <div class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="col l2">
                            <h6 class="blue-text text-darken-4">Citacion</h6>
                        ...
                        <div class="col l3">
                            ...
                            <select name="correctivo" id="correctivo">
                                <option value="SUSPENSION" selected>Suspensión</option>
                                <option value="ACADEMICO">Amonestación Verbal</option>
                                <option value="ACTA COMPROMISO">Acta de Compromiso</option>
                                <option value="CONFLICTO">Mediacion de Conflictos</option>
                            </select>
                        </div>
                        <div class="col l3">
    ...
    <div class="fixed-action-btn">
        <a href="{{ route('bienestar.registrar_citacion') }}" class="btn-floating btn-large blue darken-4">
