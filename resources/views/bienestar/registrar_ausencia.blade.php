...
@section('contenido')
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 40%">
        <h5 class="blue-text text-darken-4">Datos de Ausencia</h5><br>
        {{ Form::open(['action' => 'BienestarController@buscar_ausencia_consulta', 'method' => 'PUT']) }}
            ...
            <div class="row">
                ...
                <input type="hidden" name="opcion" value="1"> <!-- 1 PARA REGISTRO VISITA -->
            </div>
            <div class="row">
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 80%">
        <h5 class="blue-text text-darken-4">Datos de Ausencia</h5><br>
        {{ Form::open(['action' => 'BienestarController@registrar_ausencia_consulta', 'method' => 'POST']) }}
            {{csrf_field()}}
            <div class="row">
                @if (isset($flash))
                    <div class="card-panel notifications {{ $flash['color'] }}">
                ...
                <div class="col s12">
                    ...
                    <div class="row">
                        <div class="col s4 m4 l4">
                            ...
                            <input type="text" name="acudiente" id="acudiente" value="{{ $key->acudiente }}" readonly="readonly">
                        </div>
                        <div class="col s2 m2 l2">
                            <h6 class="blue-text text-darken-4">Parentesco</h6>
                            <input type="text" name="parentesco" id="parentesco" value="{{ $key->parentesco }}" readonly="readonly">
                        </div>
                        <div class="col s2 m2 l2">
                        ...
                        <div class="col s2 m2 l2">
                            <h6 class="blue-text text-darken-4"># Dias</h6>
                            <input type="number" name="dias" id="dias" required="required">
                        </div>
                        <div class="col s2 m2 l2">
    ...
    <div class="fixed-action-btn">
        <a href="{{ route('bienestar.registrar_ausencia') }}" class="btn-floating btn-large blue darken-4">
