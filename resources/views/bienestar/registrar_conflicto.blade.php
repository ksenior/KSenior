...
@section('title','Registrar mediación')
...
@section('contenido')
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 40%">
        <h5 class="blue-text text-darken-4">Datos de mediación</h5><br>
        {{ Form::open(['action' => 'BienestarController@buscar_ausencia_consulta', 'method' => 'PUT']) }}
            ...
            <div class="row">
                ...
                <input type="hidden" name="opcion" value="4"> <!-- 3 PARA REGISTRO COMPROMISO -->
            </div>
            <div class="row">
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 22px 32px 22px 32px; border: 1px solid #EEE; width: 80%">
        <h5 class="blue-text text-darken-4">Datos de mediación</h5><br>
        {{ Form::open(['action' => 'BienestarController@registrar_conflicto_consulta', 'method' => 'POST']) }}
            {{csrf_field()}}
            <div class="row">
                @if (isset($flash))
                    <div class="card-panel notifications {{ $flash['color'] }}">
                ...
                <div class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            ...
                            <input type="text" name="motivo" id="motivo" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <h6 class="blue-text text-darken-4">VERSION ESTUDIANTE</h6>
                            <input type="text" name="vestudiante" id="vestudiante" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <h6 class="blue-text text-darken-4">VERSION DOCENTE</h6>
                            <input type="text" name="vdocente" id="vdocente" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <h6 class="blue-text text-darken-4">VERSION PADRE DE FAMILIA</h6>
                            <input type="text" name="vfamilia" id="vfamilia" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <h6 class="blue-text text-darken-4">OBSERVACION</h6>
                            <input type="text" name="observacion" id="observacion" required="required">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <h6 class="blue-text text-darken-4">DOCENTE</h6>
    ...
    <div class="fixed-action-btn">
        <a href="{{ route('bienestar.registrar_conflicto') }}" class="btn-floating btn-large blue darken-4">
